...
class YahtzeeBot:
    def __init__(self) -> None:
        ...
        self.average_cache: dict = {}

    def roll_dice(self, num_dice=5) -> list:
        # Roll the dice
        dice = [random.randint(1, 6) for i in range(num_dice)]
        return dice

    def calculate_score(self, dice: list, category) -> int:
    ...
    def _score_roll(self, dice: list, category) -> int:
        category_num = None
    ...
    def get_best_dice_to_keep(self, dice) -> list:
    ...
    def choose_category(self, dice_rolled) -> list:
    ...
    def calculate_category_average(self) -> int:
